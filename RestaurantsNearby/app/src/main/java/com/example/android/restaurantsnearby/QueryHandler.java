...
//                String rCity = location.getString("city");
                double rLatitude = location.getDouble("latitude");
                double rLongitude= location.getDouble("longitude");
                Restaurants restaurant = new Restaurants(restaurantName,rating,thumbURL,profileURL,rAddress,rLatitude,rLongitude );
